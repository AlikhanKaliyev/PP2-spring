...
print(items)
count=re.findall(r'[0-9]+\,[0-9]{3}',data)
unit_price=re.findall(r'x\s([0-9]*\s*[0-9]+,0{2})',data)
total_price=re.findall(r'Стоимость\n([0-9]*\s*[0-9]+\,0{2})',data)
print('1.Name of the company :',name.group())
print('2.BIN number :',BIN.group())
for i in range(len(items)):
    print('1.Title :',items[i])
    print('2.Count :',count[i])
    print('3.Unit price :',unit_price[i])
    print('4.Total price :',total_price[i])
date=re.search(r'Время: ([0-1]*[0-9]\.[0-3][0-9]\.[0-9]{4}\s[0-2][0-8]\:[0-5][0-9]\:[0-5][0-9])',data)
address=re.search(r'г\.\s(.*)',data)
